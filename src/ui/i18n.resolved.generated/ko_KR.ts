...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "fullTransfer": {
      ...
      "title": "설정 가져오기 / 내보내기",
      "fullSettings": "전체 설정",
      "intro": "이 기기에 저장된 모든 설정을 하나의 코드나 파일로 내보내고 다른 기기나 브라우저에서 가져올 수 있습니다: 그래픽, 오디오, 인터페이스, 테마, 프레임 배치, 모든 캐릭터의 단축키, 컨트롤러와 크로스 핫바 설정, 채팅, 창 필터, 언어, 닫은 안내.",
      "excluded": "포함되지 않는 항목: 로그인, 계정, 지갑, 구매 데이터. 행동 단축바 배치는 계정에 저장되어 계정과 함께 이동합니다.",
      "downloadFile": "파일 다운로드",
      "downloaded": "다운로드를 시작했습니다.",
      "downloadFailed": "여기서는 다운로드할 수 없습니다. 복사를 사용하세요.",
      "loadFile": "파일 불러오기",
      "fileLoaded": "파일을 불러왔습니다. 적용 후 다시 불러오기를 눌러 가져오세요.",
      "loadFailed": "그 파일을 읽을 수 없습니다."
    },
    "riftForge": {
      "title": "균열의 화로",
      "subtitle": "균열결속 반지",
