...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.controller.crossHotbarEditHint': '配置変更中 · 十字キーで移動 · 決定で持ち上げて配置 · キャンセルでマスを空に',
  ...
  'hudChrome.controller.crossHotbarOwnsButtons': 'クロスホットバーが有効な間、トリガーは修飾キーとして機能します。方向キーはメニュー操作や移動用としてここで編集できます。',
