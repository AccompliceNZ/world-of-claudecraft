...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.actionBar.replaceTitle': '替换按键绑定？',
  'hudChrome.actionBar.replaceBody': '{slot} 已绑定到 {current}。要替换为 {key} 吗？',
  'hudChrome.actionBar.replaceConflictBody': '{slot} 已绑定到 {current}，而 {key} 已绑定到 {other}。替换后将解除 {other} 的绑定。',
  'hudChrome.actionBar.replaceAccept': '替换',
