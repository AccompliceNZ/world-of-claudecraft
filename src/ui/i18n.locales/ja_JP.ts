...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.fullTransfer.intro': 'この端末に保存されたすべての設定を1つのコードまたはファイルとしてエクスポートし、別の端末やブラウザでインポートできます。対象: グラフィック、オーディオ、インターフェース、テーマ、フレーム配置、全キャラクターのキー設定、コントローラーとクロスホットバーの設定、チャット、ウィンドウのフィルター、言語、閉じたヒント。',
  'hudChrome.fullTransfer.excluded': '含まれないもの: ログイン、アカウント、ウォレット、購入データ。アクションバーの配置はアカウントに保存され、アカウントと共に引き継がれます。',
  'hudChrome.fullTransfer.downloadFile': 'ファイルをダウンロード',
  'hudChrome.fullTransfer.downloaded': 'ダウンロードを開始しました。',
  'hudChrome.fullTransfer.downloadFailed': 'ここではダウンロードできません。コピーを使用してください。',
  'hudChrome.fullTransfer.loadFile': 'ファイルを読み込む',
  'hudChrome.fullTransfer.fileLoaded': 'ファイルを読み込みました。「適用して再読み込み」を押してインポートしてください。',
  'hudChrome.fullTransfer.loadFailed': 'そのファイルを読み取れませんでした。',
