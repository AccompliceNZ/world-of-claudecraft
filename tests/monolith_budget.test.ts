...
const MONOLITHS: MonolithRow[] = [
  ...
  },
  {
    ...
    // Re-pinned at this release/v0.42.0 reconcile: the current release line's
    // roster/history work composes with the candidate edits. Measured on the
  ...
  },
  {
    ...
    // tree after the release-line and candidate render changes composed.
    // Exact count, zero slack.
    ceiling: 13108,
  ...
  },
  {
    ...
    // Re-pinned at this release/v0.42.0 reconcile after that release-side
    // deletion composed with the candidate entry wiring. Measured with wc -l.
    // Exact count, zero headroom.
    ceiling: 11489,
