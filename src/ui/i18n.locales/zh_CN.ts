...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.fullTransfer.intro': '将此设备上保存的全部偏好导出为一段代码或文件，并在其他设备或浏览器上导入：图形、音频、界面、主题、框体布局、每个角色的按键绑定、手柄与十字热键栏绑定、聊天、窗口筛选、语言以及已关闭的提示。',
  'hudChrome.fullTransfer.excluded': '绝不包含：您的登录、账号、钱包或购买数据。动作条布局保存在您的账号中，会随账号同步。',
  'hudChrome.fullTransfer.downloadFile': '下载文件',
  'hudChrome.fullTransfer.downloaded': '下载已开始。',
  'hudChrome.fullTransfer.downloadFailed': '此处无法下载。请改用复制。',
  'hudChrome.fullTransfer.loadFile': '载入文件',
  'hudChrome.fullTransfer.fileLoaded': '文件已载入。按“应用并重新载入”以导入。',
  'hudChrome.fullTransfer.loadFailed': '无法读取该文件。',
