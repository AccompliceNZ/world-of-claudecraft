...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.actionBar.replaceTitle': '取代按鍵綁定？',
  'hudChrome.actionBar.replaceBody': '{slot} 已綁定到 {current}。要取代為 {key} 嗎？',
  'hudChrome.actionBar.replaceConflictBody': '{slot} 已綁定到 {current}，而 {key} 已綁定到 {other}。取代後將解除 {other} 的綁定。',
  'hudChrome.actionBar.replaceAccept': '取代',
