...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "classPage": {
      ...
      "formsWolfEngage": "늑대는 큰곰 돌진으로 싸움을 열고, 곧바로 늑대 변신으로 바꿔 대상을 고정하며, 은신하지 않을 때는 도약 습격으로 거리를 좁히고, 뒷다리 물기로 적을 붙잡아 둡니다.",
      "formLine": {
  ...
  "entities": {
    "abilities": {
      ...
      "hamstring_bite": {
        "name": "뒷다리 물기",
        "description": "마무리 기술. 대상을 0.5초에 연계 점수당 0.5초를 더한 시간 동안 기절시킵니다. 늑대 변신 상태에서만 사용 가능."
      },
      "insect_swarm": {
        "name": "쏘는 벌레 떼",
