...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.actionBar.replaceTitle': 'キー設定を置き換えますか？',
  'hudChrome.actionBar.replaceBody': '{slot} は {current} に割り当てられています。{key} に置き換えますか？',
  'hudChrome.actionBar.replaceConflictBody': '{slot} は {current} に割り当てられており、{key} はすでに {other} に割り当てられています。置き換えると {other} の割り当てが解除されます。',
  'hudChrome.actionBar.replaceAccept': '置き換える',
