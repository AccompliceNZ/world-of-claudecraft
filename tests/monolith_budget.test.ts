...
const MONOLITHS: MonolithRow[] = [
  ...
  },
  {
    ...
    // Re-pinned at the second v0.42.0 release-base reconcile: the controller
    // extraction, release-side hotkey work, and batch HUD edits compose here.
    // Measured with wc -l on the merged tree. Exact merged count, zero slack.
    ceiling: 18802,
  ...
  },
  {
    ...
    // Re-pinned at the second v0.42.0 release-base reconcile after those
    // renderer changes composed with the batch renderer edits. Measured with
    // wc -l on the merged tree. Exact merged count, zero headroom.
    ceiling: 13094,
  ...
  },
  {
    ...
    // merged tree. Exact merged count, zero headroom.
    // Re-pinned at the second v0.42.0 release-base reconcile after that
    // release-side extraction composed with the batch entry wiring. Measured
    // with wc -l on the merged tree. Exact count, zero headroom.
    ceiling: 11475,
  ...
  },
  {
    ...
    // tree after the release-line and candidate database wiring composed.
    // Exact count, zero slack.
    ceiling: 5013,
  ...
  },
  {
    ...
    // Re-pinned at this release/v0.42.0 reconcile. Measured on the merged
    // tree after the release-line and candidate nameplate rendering composed.
    // Exact count, zero slack.
    ceiling: 901,
