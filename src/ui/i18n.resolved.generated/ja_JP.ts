...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "fullTransfer": {
      ...
      "fullSettings": "すべての設定",
      "intro": "この端末に保存されたすべての設定を1つのコードまたはファイルとしてエクスポートし、別の端末やブラウザでインポートできます。対象: グラフィック、オーディオ、インターフェース、テーマ、フレーム配置、全キャラクターのキー設定、コントローラーとクロスホットバーの設定、チャット、ウィンドウのフィルター、言語、閉じたヒント。",
      "excluded": "含まれないもの: ログイン、アカウント、ウォレット、購入データ。アクションバーの配置はアカウントに保存され、アカウントと共に引き継がれます。",
      "downloadFile": "ファイルをダウンロード",
      "downloaded": "ダウンロードを開始しました。",
      "downloadFailed": "ここではダウンロードできません。コピーを使用してください。",
      "loadFile": "ファイルを読み込む",
      "fileLoaded": "ファイルを読み込みました。「適用して再読み込み」を押してインポートしてください。",
      "loadFailed": "そのファイルを読み取れませんでした。"
    },
    "riftForge": {
      "title": "リフトの炉",
      "subtitle": "リフトバウンドリング",
