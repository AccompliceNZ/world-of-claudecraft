...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.actionBar.replaceTitle': '단축키를 바꾸시겠습니까?',
  'hudChrome.actionBar.replaceBody': '{slot}에는 {current} 키가 지정되어 있습니다. {key} 키로 바꾸시겠습니까?',
  'hudChrome.actionBar.replaceConflictBody': '{slot}에는 {current} 키가 지정되어 있고, {key} 키는 이미 {other}에 지정되어 있습니다. 바꾸면 {other}의 지정이 해제됩니다.',
  'hudChrome.actionBar.replaceAccept': '바꾸기',
