...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.controller.crossHotbarEditHint': '整理中 · 十字鍵移動 · 確認拿起並放置 · 取消清空格子',
  'hudChrome.controller.padHintLabel': '手把提示',
  'hudChrome.controller.padHintInteract': '互動',
  'hudChrome.controller.padHintTargetMenu': '目標選單',
  'hudChrome.controller.padHintSwapSet': '切換組',
  'hudChrome.controller.padHintArrangeBar': '整理動作列',
  'hudChrome.controller.padLegendBags': '背包',
  'hudChrome.controller.padLegendMenu': '選單',
  'hudChrome.controller.padLegendCycleHud': '切換介面',
  'hudChrome.controller.crossHotbarEditHelp': '按住左肩鍵並按上方面鍵，即可用手把整理十字熱鍵列。',
  'hudChrome.controller.crossHotbarOwnsButtons': '十字熱鍵欄啟用時，扳機鍵會作為修飾鍵。方向鍵仍可在此編輯，用於選單和移動。',
  ...
  'hudChrome.interactPrompt.talk': '交談',
  'hudChrome.partyFrames.header': '隊伍',
  'hudChrome.interactPrompt.loot': '拾取戰利品',
  'hudChrome.interactPrompt.open': '開啟',
  'hudChrome.interactPrompt.gather': '採集',
  'hudChrome.interactPrompt.mail': '查看郵件',
  'hudChrome.interactPrompt.bank': '使用銀行',
  'hudChrome.interactPrompt.use': '使用',
  'hudChrome.interactPrompt.harvest': '剝取',
  'hudChrome.interactPrompt.gardenBed': '菜園苗床',
