...
export const ja_JP: EnTranslations = {
  ...
  "guide": {
    ...
    "classPage": {
      ...
      "formsWolfEngage": "狼はブルーインラッシュで戦いを開き、すぐにウルフフォームへ変身して対象を押さえ込み、ステルスでないときはランジで距離を詰め、ハムストリングバイトで敵を足止めする。",
      "formLine": {
  ...
  "entities": {
    "abilities": {
      ...
      "hamstring_bite": {
        "name": "ハムストリングバイト",
        "description": "フィニッシュ技。対象を0.5秒に加えコンボポイント1つにつき0.5秒間スタンさせる。ウルフフォーム時のみ使用可能。"
      },
      "insect_swarm": {
        "name": "刺す虫の群れ",
